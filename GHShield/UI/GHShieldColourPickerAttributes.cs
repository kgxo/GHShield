...
{
    /// <summary>
    /// Protection adapter for a Colour Picker.
    ///
    /// The Colour Picker is edited by dragging directly across its gradient
    /// field.
    ///
    ...
    /// </summary>
    public class GHShieldColourPickerAttributes : GH_ColourPickerAttributes, IGHShieldAttributes
    {
        public GHShieldColourPickerAttributes(Grasshopper.Kernel.Special.GH_ColourPickerObject owner)
            : base(owner)
        {
        }
        ...
        private GH_ObjectResponse Block(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            ...
            Log.Debug($"Frozen a Colour Picker '{Owner.NickName}': interaction blocked.");
