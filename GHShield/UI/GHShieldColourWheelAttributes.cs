...
{
    /// <summary>
    /// Protection adapter for a Colour Wheel.
    ///
    /// The Colour Wheel is edited by dragging its handles around the wheel.
    ///
    ...
    /// </summary>
    public class GHShieldColourWheelAttributes : GH_ColourWheelAttributes, IGHShieldAttributes
    {
        public GHShieldColourWheelAttributes(Grasshopper.Kernel.Special.GH_ColourWheel owner)
            : base(owner)
        {
        }
        ...
        private GH_ObjectResponse Block(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            ...
            Log.Debug($"Frozen a Colour Wheel '{Owner.NickName}': interaction blocked.");
