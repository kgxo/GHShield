...
{
    /// <summary>
    /// Protection adapter for an Image Sampler.
    ///
    /// An Image Sampler opens its own settings dialog on double-click.
    ///
    ...
    /// </summary>
    public class GHShieldImageSamplerAttributes : GH_ImageSamplerAttributes, IGHShieldAttributes
    {
        public GHShieldImageSamplerAttributes(Grasshopper.Kernel.Special.GH_ImageSampler owner)
            : base(owner)
        {
        }
        ...
        private GH_ObjectResponse Block(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            ...
            Log.Debug($"Frozen an Image Sampler '{Owner.NickName}': interaction blocked.");
