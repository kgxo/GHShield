...
{
    /// <summary>
    /// Protection adapter for a Panel.
    ///
    /// A Panel is edited in place by double-clicking and typing, which never
    /// passes through the document object at all.
    ///
    ...
    /// </summary>
    public class GHShieldPanelAttributes : GH_PanelAttributes, IGHShieldAttributes
    {
        public GHShieldPanelAttributes(Grasshopper.Kernel.Special.GH_Panel owner)
            : base(owner)
        {
        }
        ...
        private GH_ObjectResponse Block(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            ...
            Log.Debug($"Frozen a Panel '{Owner.NickName}': interaction blocked.");
