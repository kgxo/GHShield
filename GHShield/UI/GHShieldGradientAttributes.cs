...
{
    /// <summary>
    /// Protection adapter for a Gradient.
    ///
    /// A Gradient is edited by dragging, adding and removing colour stops on the
    /// object itself.
    ///
    ...
    /// </summary>
    public class GHShieldGradientAttributes : GH_GradientControlAttributes, IGHShieldAttributes
    {
        public GHShieldGradientAttributes(Grasshopper.Kernel.Special.GH_GradientControl owner)
            : base(owner)
        {
        }
        ...
        private GH_ObjectResponse Block(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            ...
            Log.Debug($"Frozen a Gradient '{Owner.NickName}': interaction blocked.");
