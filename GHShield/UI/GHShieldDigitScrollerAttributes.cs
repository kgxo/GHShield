...
{
    /// <summary>
    /// Protection adapter for a Digit Scroller.
    ///
    /// A Digit Scroller changes value by dragging individual digits up and down.
    ///
    ...
    /// </summary>
    public class GHShieldDigitScrollerAttributes : GH_DigitScrollerAttributes, IGHShieldAttributes
    {
        public GHShieldDigitScrollerAttributes(
            Grasshopper.Kernel.Special.GH_DigitScroller owner)
            : base(owner)
        {
        }
        ...
        private GH_ObjectResponse Block(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            ...
            Log.Debug($"Frozen a Digit Scroller '{Owner.NickName}': interaction blocked.");
