...
{
    /// <summary>
    /// Protection adapter for a Colour Swatch.
    ///
    /// A Colour Swatch opens a colour dialog on double-click and drags its own
    /// value bars on click.
    ///
    ...
    /// </summary>
    public class GHShieldColourSwatchAttributes : GH_ColourSwatchAttributes, IGHShieldAttributes
    {
        public GHShieldColourSwatchAttributes(Grasshopper.Kernel.Special.GH_ColourSwatch owner)
            : base(owner)
        {
        }
        ...
        private GH_ObjectResponse Block(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            ...
            Log.Debug($"Frozen a Colour Swatch '{Owner.NickName}': interaction blocked.");
