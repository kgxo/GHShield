...
{
    /// <summary>
    /// Protection adapter for an MD Slider.
    ///
    /// An MD Slider is edited by dragging its grip across a 2D field.
    ///
    ...
    /// </summary>
    public class GHShieldMDSliderAttributes : GH_MultiDimensionalSliderAttributes, IGHShieldAttributes
    {
        public GHShieldMDSliderAttributes(Grasshopper.Kernel.Special.GH_MultiDimensionalSlider owner)
            : base(owner)
        {
        }
        ...
        private GH_ObjectResponse Block(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            ...
            Log.Debug($"Frozen an MD Slider '{Owner.NickName}': interaction blocked.");
